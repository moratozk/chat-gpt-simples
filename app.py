...
def main():
    ...
    st.title("💬 Chat dos Bigodes da Fatec")
    st.write("Converse com o modelo mais ref de todos!")
    ...
    if pergunta := st.chat_input("Digite sua pergunta:"):
        ...
        st.session_state.mensagens.append({"role": "system", "content": "você é um assistente utilizado para responder as perguntas com girias de adolescentes"})
